...
namespace HMS
{
    public partial class FormPharmasistReg : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sql = "INSERT INTO pharmasist(id,first_name,last_name,date,address,tel,password) VALUES (@id,@fname,@lname,@bday,@address,@tel,@password)";
            ...
            {
                MessageBox.Show("Pharmasist Added Succesfully");
                conn.Close();
            }
        }
    }
